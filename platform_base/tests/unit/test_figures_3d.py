...
class TestTrajectory3D:
    ...
    def test_trajectory_with_colormap(self):
        ...
        try:
            ...
            plot_trajectory_3d(x, y, z, colormap="viridis")
            assert True
        except ImportError:
            pytest.skip("plot_trajectory_3d não disponível")
        except Exception as e:
    ...
    def test_trajectory_with_color_by_value(self):
        ...
        try:
            ...
            plot_trajectory_3d(x, y, z, color_values=color_values)
            assert True
        except ImportError:
            pytest.skip("plot_trajectory_3d não disponível")
        except Exception:
...
class TestScatter3D:
    ...
    def test_scatter3d_with_size(self):
        ...
        try:
            ...
            scatter3d(x, y, z, point_size=sizes)
            assert True
        except ImportError:
            pytest.skip("scatter3d não disponível")
        except Exception:
...
class TestSurface3D:
    ...
    def test_surface3d_with_colormap(self):
        ...
        try:
            ...
            surface3d(X, Y, Z, colormap="plasma")
            assert True
        except ImportError:
            pytest.skip("surface3d não disponível")
        except Exception:
