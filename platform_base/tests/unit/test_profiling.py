...
from platform_base.profiling.decorators import performance_critical, profile, set_global_profiler
from platform_base.profiling.profiler import create_auto_profiler_from_config
...
class TestAutoProfiler:
    ...
    def test_performance_targets(self):
        ...
        # Verifica targets
        fast_result = next(r for r in results if r.metadata.get("target_name") == "fast_target")
        slow_result = next(r for r in results if r.metadata.get("target_name") == "slow_target")
    ...
    def test_memory_profiling(self):
        ...
        profiler.profile_function(memory_intensive_function)
