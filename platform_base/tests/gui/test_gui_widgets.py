...
class TestPlot2DWidget:
    ...
    def test_widget_show(self, qtbot):
    ...
    def test_add_series(self, qtbot, sample_data):
        ...
        # Add series
        widget.add_series("test_series", t, y, "Test Data")
        
        # Should have the series
        assert "test_series" in widget._curves
    
    def test_clear_plot(self, qtbot, sample_data):
        ...
        assert len(widget._curves) == 0
    
    def test_toggle_grid(self, qtbot):
        """Verifica toggle de grid"""
        from platform_base.viz.figures_2d import Plot2DWidget
        
        widget = Plot2DWidget()
        qtbot.addWidget(widget)
        
        # Toggle grid - just verify no crash
        widget.toggle_grid()
...
class TestDataPanelWidget:
    ...
    def test_panel_has_tree_widget(self, qtbot):
...
class TestUploadDialog:
    ...
    def test_dialog_has_preview_table(self, qtbot):
    ...
    def test_dialog_accept_reject_buttons(self, qtbot):
        """Verifica botões de aceitar/rejeitar"""
        from platform_base.desktop.dialogs.upload_dialog import UploadDialog
        ...
        # Should have ok/cancel or similar buttons
        assert any("ok" in t or "confirmar" in t or "carregar" in t for t in button_texts) or \
               any("cancel" in t or "cancelar" in t for t in button_texts)
...
class TestVizPanel:
    ...
    def test_panel_has_tab_widget(self, qtbot):
        """Verifica que painel tem tab widget"""
        from platform_base.desktop.widgets.viz_panel import VizPanel
        
        panel = VizPanel()
        qtbot.addWidget(panel)
        
        # Should have tabs for plots
...
class TestWidgetSignals:
    ...
    def test_plot_selection_signal(self, qtbot, sample_data):
        ...
        # Add series and check signal exists
        widget.add_series("test", t, y, "Test")
