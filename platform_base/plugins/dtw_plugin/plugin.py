...
class DTWConfig:
    ...
    window_size: int | None = None  # Sakoe-Chiba band constraint
...
class DTWPlugin(PluginProtocol):
    ...
    def compute_dtw_distance(self,
                           series1: np.ndarray,
                           series2: np.ndarray,
                           config: DTWConfig | None = None) -> DTWResult:
        """
    ...
    def compute_dtw_batch(self,
                         ...
                         config: DTWConfig | None = None) -> np.ndarray:
        """
    ...
    def visualize_dtw_alignment(self,
                              ...
                              series2: np.ndarray,
                              result: DTWResult,
                              title: str = "DTW Alignment") -> Any | None:
        """
        ...
        if result.cost_matrix is not None:
            ...
            # Plot optimal path
            if result.path:
                path_i, path_j = zip(*result.path, strict=False)
