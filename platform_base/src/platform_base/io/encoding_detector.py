...
def detect_bom(file_path: Path) -> str | None:
    """
...
def detect_with_chardet(file_path: Path, sample_size: int = 10000) -> tuple[str | None, float]:
    """
...
def detect_by_trial(file_path: Path) -> str | None:
    """
