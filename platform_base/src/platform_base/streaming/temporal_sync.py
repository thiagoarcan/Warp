...
class TemporalSynchronizer(QObject):
    ...
    def start_streaming(self, fps: float = None):
    ...
    def _find_closest_frame(self, buffer: List[StreamFrame], target_timestamp: float) -> Optional[StreamFrame]:
    ...
    def _on_frame_ready(self, series_id: str, frame_data: Any):
        ...
        for plot_id, plot_widget in self.plot_widgets.items():
            try:
                ...
                logger.error("streaming_plot_update_failed", 
