...
from platform_base.core.config import (
    ConfigManager as BaseConfigManager,
    ConfigSource, ConfigChange, ConfigScope, ConfigFormat,
    get_config_manager
)
...
class AdvancedConfigManager:
    ...
    def __init__(self, base_config_manager: Optional[BaseConfigManager] = None):
    ...
    def register_schema(self, name: str, schema_class: type):
        ...
        with self._validation_lock:
            ...
            cache_keys = [k for k in self.validation_cache.keys() if k.startswith(f"{name}:")]
        ...
        try:
            ...
            for callback in self.validation_callbacks:
                try:
                    ...
                    logger.error("validation_callback_failed", error=str(cb_error))
        ...
        if not result.valid:
            ...
            for callback in self.error_callbacks:
                try:
                    ...
                    logger.error("error_callback_failed", error=str(cb_error))
    ...
    def _on_config_change(self, change: ConfigChange):
        ...
        for schema_name in affected_schemas:
            try:
                ...
                logger.error("config_change_validation_failed",
    ...
    @contextmanager
    def atomic_update(self, schema_name: Optional[str] = None):
    ...
    def backup_config(self, backup_dir: Optional[Path] = None) -> Path:
    ...
    def restore_from_backup(self, backup_file: Path, validate: bool = True):
        ...
        with self._lock:
            ...
            try:
                ...
                logger.error("config_restore_failed", error=str(e))
...
_global_advanced_config: Optional[AdvancedConfigManager] = None
