...
from platform_base.viz.streaming import StreamingEngine, StreamingState, TickUpdate, StreamFilters, TimeInterval
...
class StreamingControlWidget(QWidget):
    ...
    def get_current_update(self) -> Optional[TickUpdate]:
