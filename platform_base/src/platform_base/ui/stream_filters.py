...
from platform_base.viz.streaming import (
    StreamFilters, TimeInterval, ValuePredicate, SmoothConfig, ScaleConfig
)
...
class TimeIntervalWidget(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self.current_interval: Optional[TimeInterval] = None
        self._setup_ui()
    ...
    def set_interval(self, interval: Optional[TimeInterval]):
        """Define intervalo"""
        if interval:
...
class ValuePredicateWidget(QWidget):
    ...
    def __init__(self, series_id: str, parent: Optional[QWidget] = None):
        super().__init__(parent)
        
        self.series_id = series_id
        self.current_predicate: Optional[ValuePredicate] = None
        self._setup_ui()
    ...
    def get_predicate(self) -> Optional[ValuePredicate]:
        """Retorna predicado atual"""
        return self.current_predicate
    
    def set_predicate(self, predicate: Optional[ValuePredicate]):
        """Define predicado"""
        if predicate:
...
class StreamFiltersWidget(QWidget):
    ...
    def __init__(self, available_series: List[str] = None, parent: Optional[QWidget] = None):
        super().__init__(parent)
    ...
    @pyqtSlot(str, object)
    def _on_predicate_changed(self, series_id: str, predicate: Optional[ValuePredicate]):
