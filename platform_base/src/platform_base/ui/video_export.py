...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QProgressBar, QLabel, QSpinBox, QComboBox,
    QCheckBox, QFileDialog, QMessageBox, QGroupBox
)
from PyQt6.QtGui import QPixmap

from platform_base.viz.streaming import StreamingEngine, TickUpdate
...
class VideoExportWorker(QThread):
    ...
    def _capture_current_frame(self) -> Optional[Any]:
        ...
        elif self.settings.layout_mode == "grid":
    ...
    def _capture_single_view_frame(self) -> Optional[Any]:
        ...
        try:
            ...
            logger.error("frame_capture_failed", error=str(e))
            return None
    
    def _capture_grid_frame(self) -> Optional[Any]:
        ...
        for i, view_id in enumerate(active_views):
    ...
    def _get_master_streaming_engine(self) -> Optional[StreamingEngine]:
...
class VideoExportDialog(QDialog):
    ...
    def __init__(self, synchronizer: MultiViewSynchronizer, parent: Optional[QWidget] = None):
        super().__init__(parent)
...
def export_video_programmatically(settings: VideoExportSettings, 
    ...
    try:
        ...
        logger.error("programmatic_video_export_failed", error=str(e))
        return False