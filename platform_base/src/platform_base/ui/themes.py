...
class ThemeManager(QObject):
    ...
    def _create_stylesheet(self) -> str:
        """Cria stylesheet CSS ergonômico baseado no tema atual."""
        from platform_base.ui.ergonomic_styles import generate_ergonomic_stylesheet
        return generate_ergonomic_stylesheet(self._current_colors)
