...
class SignalHub(QObject):
    ...
    def emit(self, event_type: EventType, source: str, data: Optional[Dict[str, Any]] = None):
        """
    ...
    def emit_operation_completed(self, source: str, operation_name: str,
                                 result: Any = None, operation_id: Optional[str] = None):
    ...
    def emit_operation_failed(self, source: str, operation_name: str, 
                              error: str, operation_id: Optional[str] = None):
    ...
    def get_last_event(self, event_type: EventType) -> Optional[HubEvent]:
...
def emit_event(event_type: EventType, source: str, data: Optional[Dict[str, Any]] = None):
