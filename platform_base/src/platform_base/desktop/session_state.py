...
class SessionState(QObject):
    ...
    def __init__(self, dataset_store: DatasetStore, parent: Optional[QObject] = None):
    ...
    def set_current_dataset(self, dataset_id: Optional[DatasetID]):
    ...
    def set_time_window(self, time_window: Optional[TimeWindow]):
    ...
    def save_session(self, filepath: str) -> bool:
        ...
        try:
            ...
            logger.error("session_save_failed", filepath=filepath, error=str(e))
            return False
    ...
    def load_session(self, filepath: str) -> bool:
        ...
        try:
            ...
            logger.error("session_load_failed", filepath=filepath, error=str(e))
            return False
