...
class Ui_PlotContextMenu(object):
    def setupUi(self, PlotContextMenu):
        if not PlotContextMenu.objectName():
            PlotContextMenu.setObjectName(u"PlotContextMenu")
    ...
    def retranslateUi(self, PlotContextMenu):
        PlotContextMenu.setWindowTitle(QCoreApplication.translate("PlotContextMenu", u"PlotContextMenu", None))
    # retranslateUi
