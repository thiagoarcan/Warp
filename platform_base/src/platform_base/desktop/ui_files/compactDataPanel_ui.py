...
class Ui_CompactDataPanel:
    def setupUi(self, CompactDataPanel):
        if not CompactDataPanel.objectName():
            CompactDataPanel.setObjectName("CompactDataPanel")
        ...
        self.arquivoFrame.setObjectName("arquivoFrame")
    ...
    def retranslateUi(self, CompactDataPanel):
        CompactDataPanel.setWindowTitle(QCoreApplication.translate("CompactDataPanel", "Dados", None))
        self.carregarBtn.setText(QCoreApplication.translate("CompactDataPanel", "\ud83d\udcc2 Carregar Dados", None))
#if QT_CONFIG(tooltip)
        self.carregarBtn.setToolTip(QCoreApplication.translate("CompactDataPanel", "Carregar arquivo de dados (CSV, Excel, Parquet, HDF5)", None))
#endif // QT_CONFIG(tooltip)
        self.arquivoLabel.setText(QCoreApplication.translate("CompactDataPanel", "Nenhum arquivo carregado", None))
        self.arquivoLabel.setStyleSheet(QCoreApplication.translate("CompactDataPanel", "color: gray; font-style: italic;", None))
        self.infoLabel.setText("")
        self.seriesGroup.setTitle(QCoreApplication.translate("CompactDataPanel", "\ud83d\udcca S\u00e9ries de Dados", None))
        ___qtreewidgetitem = self.seriesTree.headerItem()
        ___qtreewidgetitem.setText(2, QCoreApplication.translate("CompactDataPanel", "Pontos", None))
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("CompactDataPanel", "Tipo", None))
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("CompactDataPanel", "Nome", None))
        self.dataGroup.setTitle(QCoreApplication.translate("CompactDataPanel", "\ud83d\udccb Visualiza\u00e7\u00e3o de Dados", None))
    # retranslateUi
