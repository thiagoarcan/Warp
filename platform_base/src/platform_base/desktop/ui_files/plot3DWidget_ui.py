...
class Ui_Plot3DWidget(object):
    def setupUi(self, Plot3DWidget):
        if not Plot3DWidget.objectName():
            Plot3DWidget.setObjectName(u"Plot3DWidget")
    ...
    def retranslateUi(self, Plot3DWidget):
        Plot3DWidget.setWindowTitle(QCoreApplication.translate("Plot3DWidget", u"Plot3DWidget", None))
    # retranslateUi
