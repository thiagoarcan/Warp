...
class Ui_PreviewCanvas(object):
    def setupUi(self, PreviewCanvas):
        if not PreviewCanvas.objectName():
            PreviewCanvas.setObjectName(u"PreviewCanvas")
    ...
    def retranslateUi(self, PreviewCanvas):
        PreviewCanvas.setWindowTitle(QCoreApplication.translate("PreviewCanvas", u"PreviewCanvas", None))
    # retranslateUi
