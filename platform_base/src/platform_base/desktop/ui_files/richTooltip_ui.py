...
class Ui_RichTooltip(object):
    def setupUi(self, RichTooltip):
        if not RichTooltip.objectName():
            RichTooltip.setObjectName(u"RichTooltip")
    ...
    def retranslateUi(self, RichTooltip):
        RichTooltip.setWindowTitle(QCoreApplication.translate("RichTooltip", u"RichTooltip", None))
    # retranslateUi
