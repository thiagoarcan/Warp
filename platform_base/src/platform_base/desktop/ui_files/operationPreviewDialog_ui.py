...
class Ui_OperationPreviewDialog(object):
    def setupUi(self, OperationPreviewDialog):
        ...
        OperationPreviewDialog.resize(600, 400)
        self.mainLayout = QVBoxLayout(OperationPreviewDialog)
        self.mainLayout.setObjectName(u"mainLayout")
        self.contentWidget = QWidget(OperationPreviewDialog)
        ...
        self.buttonBox.accepted.connect(OperationPreviewDialog.accept)
        self.buttonBox.rejected.connect(OperationPreviewDialog.reject)

        QMetaObject.connectSlotsByName(OperationPreviewDialog)
    # setupUi

    def retranslateUi(self, OperationPreviewDialog):
        OperationPreviewDialog.setWindowTitle(QCoreApplication.translate("OperationPreviewDialog", u"OperationPreviewDialog", None))
    # retranslateUi
