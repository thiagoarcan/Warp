...
class Ui_SelectionToolbar(object):
    def setupUi(self, SelectionToolbar):
        ...
        SelectionToolbar.resize(600, 400)
        self.mainLayout = QVBoxLayout(SelectionToolbar)
        self.mainLayout.setObjectName(u"mainLayout")
        self.contentWidget = QWidget(SelectionToolbar)
    ...
    def retranslateUi(self, SelectionToolbar):
        SelectionToolbar.setWindowTitle(QCoreApplication.translate("SelectionToolbar", u"SelectionToolbar", None))
    # retranslateUi
