...
class Ui_QueryBuilderWidget(object):
    def setupUi(self, QueryBuilderWidget):
        ...
        QueryBuilderWidget.resize(600, 400)
        self.mainLayout = QVBoxLayout(QueryBuilderWidget)
        self.mainLayout.setObjectName(u"mainLayout")
        self.contentWidget = QWidget(QueryBuilderWidget)
    ...
    def retranslateUi(self, QueryBuilderWidget):
        QueryBuilderWidget.setWindowTitle(QCoreApplication.translate("QueryBuilderWidget", u"QueryBuilderWidget", None))
    # retranslateUi
