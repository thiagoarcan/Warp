...
class Ui_VideoExportDialog(object):
    def setupUi(self, VideoExportDialog):
        ...
        VideoExportDialog.resize(600, 400)
        self.mainLayout = QVBoxLayout(VideoExportDialog)
        self.mainLayout.setObjectName(u"mainLayout")
        self.contentWidget = QWidget(VideoExportDialog)
        ...
        self.buttonBox = QDialogButtonBox(VideoExportDialog)
        ...
        self.buttonBox.accepted.connect(VideoExportDialog.accept)
        self.buttonBox.rejected.connect(VideoExportDialog.reject)

        QMetaObject.connectSlotsByName(VideoExportDialog)
    # setupUi

    def retranslateUi(self, VideoExportDialog):
        VideoExportDialog.setWindowTitle(QCoreApplication.translate("VideoExportDialog", u"VideoExportDialog", None))
    # retranslateUi
