...
class Ui_SelectionManagerWidget(object):
    def setupUi(self, SelectionManagerWidget):
        ...
        SelectionManagerWidget.resize(600, 400)
        self.mainLayout = QVBoxLayout(SelectionManagerWidget)
        self.mainLayout.setObjectName(u"mainLayout")
        self.contentWidget = QWidget(SelectionManagerWidget)
    ...
    def retranslateUi(self, SelectionManagerWidget):
        SelectionManagerWidget.setWindowTitle(QCoreApplication.translate("SelectionManagerWidget", u"SelectionManagerWidget", None))
    # retranslateUi
