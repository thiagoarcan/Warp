...
class PlatformApplication(QApplication):
    ...
    def initialize_components(self, cache_config: dict | None = None) -> bool:
        """
        ...
        try:
            ...
            logger.exception("component_initialization_failed", error=str(e))
    ...
    def create_main_window(self) -> bool:
        ...
        try:
            ...
            logger.exception("main_window_creation_failed", error=str(e))
...
def create_application(argv: list[str] | None = None,
    ...
    return PlatformApplication(argv)
