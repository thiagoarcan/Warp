...
from platform_base.core.models import DatasetID, SeriesID, TimeWindow
...
class ConditionalSelection(SelectionCriteria):
    ...
    compiled_condition: Optional[Callable] = None
    ...
    def _compile_condition(self):
        ...
        try:
            ...
            logger.error("conditional_selection_compile_error", 
...
class SelectionState:
    ...
    def __init__(self, dataset_id: DatasetID, series_id: Optional[SeriesID] = None):
        ...
        self._time_ranges: Optional[List[tuple[float, float]]] = None
        self._value_stats: Optional[Dict[str, float]] = None
        self._dirty = True
    ...
    def apply_criteria(self, criteria: SelectionCriteria, 
        ...
        for i, (t, val) in enumerate(zip(t_data, value_data)):
...
class SelectionManager(QObject):
    ...
    def __init__(self, parent: Optional[QObject] = None):
        ...
        self._selection_states: Dict[tuple[DatasetID, Optional[SeriesID]], SelectionState] = {}
        ...
        self._primary_series: Optional[tuple[DatasetID, SeriesID]] = None
        
        logger.debug("selection_manager_initialized")
    
    def get_selection_state(self, dataset_id: DatasetID, 
                          series_id: Optional[SeriesID] = None) -> SelectionState:
    ...
    def apply_temporal_selection(self, dataset_id: DatasetID, series_id: Optional[SeriesID],
    ...
    def apply_graphical_selection(self, dataset_id: DatasetID, series_id: Optional[SeriesID],
    ...
    def apply_conditional_selection(self, dataset_id: DatasetID, series_id: Optional[SeriesID],
    ...
    def _apply_criteria(self, dataset_id: DatasetID, series_id: Optional[SeriesID],
    ...
    def _apply_coordinated_temporal_selection(self, criteria: TemporalSelection,
                                            ...
                                            primary_series: Optional[SeriesID]):
        ...
        for (dataset_id, series_id), state in self._selection_states.items():
            ...
            coord_criteria = TemporalSelection(
    ...
    def clear_selection(self, dataset_id: Optional[DatasetID] = None, 
        ...
        for key_str, criteria_list in imported_data.items():
            ...
            for criteria_data in criteria_list:
                try:
                    ...
                    logger.error("selection_import_error", 
