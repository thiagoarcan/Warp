...
class DataExportWorker(BaseWorker):
    ...
    def __init__(self, dataset_store, dataset_id: str, series_ids: Optional[List[str]],
    ...
    def run(self):
        ...
        try:
            ...
            for series_id, series in selected_series.items():
            ...
            self.emit_error(f"Export failed: {str(e)}")
...
class SessionExportWorker(BaseWorker):
    ...
    def run(self):
        ...
        try:
            ...
            self.emit_error(f"Session export failed: {str(e)}")
...
class PlotExportWorker(BaseWorker):
    ...
    def run(self):
        ...
        try:
            ...
            dpi = self.export_config.get("dpi", 300)
            ...
            self.emit_error(f"Plot export failed: {str(e)}")
...
class VideoExportWorker(BaseWorker):
    ...
    def run(self):
        ...
        try:
            ...
            self.emit_error(f"Video export failed: {str(e)}")
...
class ExportWorkerManager:
    ...
    def start_data_export(self, operation_id: str, dataset_id: str, 
                         series_ids: Optional[List[str]], output_path: str,
