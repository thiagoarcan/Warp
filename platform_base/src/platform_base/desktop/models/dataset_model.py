...
from platform_base.core.models import DatasetID, SeriesID, Dataset, Series
...
class TreeItem:
    ...
    def __init__(self, data: List[Any], parent_item: Optional['TreeItem'] = None):
        self.item_data = data
...
class DatasetTreeModel(QAbstractItemModel):
        ...
        try:
            ...
            for summary in dataset_summaries:
                ...
                try:
                    ...
                    logger.error("failed_to_load_series_for_dataset", 
            ...
            logger.error("failed_to_refresh_dataset_model", error=str(e))
    ...
    def add_dataset(self, dataset_id: str):
        ...
        try:
            ...
            logger.error("failed_to_add_dataset_to_model", 
        ...
        for dataset_row in range(self.root_item.child_count()):
            ...
            if dataset_item and dataset_item.dataset_id == dataset_id:
                ...
                try:
                    ...
                    logger.error("failed_to_add_series_to_model",
    ...
    def _load_series_for_dataset(self, dataset_item: TreeItem):
        ...
        try:
            ...
            logger.error("failed_to_load_series",
