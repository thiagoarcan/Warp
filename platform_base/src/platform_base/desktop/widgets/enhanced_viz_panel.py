...
from platform_base.viz.multi_canvas_plot import IndependentPlotCanvas, MultiCanvasPlotWidget
...
class EnhancedVizPanel(QWidget):
    ...
    def _handle_calculation_request(self, canvas: IndependentPlotCanvas,
        ...
        try:
            ...
            QMessageBox.critical(self, "Erro", f"Falha no cálculo: {e!s}")
    ...
    def _handle_export_request(self, canvas, series_id, format_type):
        ...
        try:
            ...
            QMessageBox.critical(self, "Erro", f"Falha na exportação: {e!s}")
    ...
    def _export_series_data(self, canvas, series_id, file_path, format_type):
        ...
        if format_type in {"xlsx", "xlsx_annotated"}:
    ...
    def _load_and_plot_series(self, canvas: IndependentPlotCanvas,
        ...
        try:
            ...
            elif hasattr(dataset, "data") and series_id in dataset.data:
