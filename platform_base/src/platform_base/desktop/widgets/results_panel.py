...
from PyQt6.QtWidgets import (
    ...
    QLabel, QProgressBar, QGroupBox, QSplitter,
...
class LogWidget(QTextEdit):
    ...
    def add_log_entry(self, level: str, message: str, timestamp: datetime = None, **kwargs):
        """Add log entry"""
...
"""
            ...
            logger.error("failed_to_update_quality_metrics", error=str(e))
