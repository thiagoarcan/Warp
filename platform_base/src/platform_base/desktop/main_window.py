...
class MainWindow(QMainWindow, UiLoaderMixin):
    ...
    # =========================================================================
    # PROGRAMMATIC UI METHODS - MOVED TO DEPRECATED FOLDER
    # =========================================================================
    # All programmatic UI creation methods have been REMOVED and moved to:
    # src/platform_base/deprecated_programmatic_ui/main_window_programmatic_fallbacks.py.txt
    #
    # Per custom instruction #3: "Não são admitidos fallbacks para interfaces"
    # All UI must be loaded exclusively from mainWindow.ui (497 lines)
    #
    # Removed methods (now in deprecated folder):
    #   - _setup_window()
    #   - _create_dockable_panels()
    #   - _create_menu_bar()
    #   - _create_tool_bar()
    #   - _create_status_bar()
    #
    # See: src/platform_base/deprecated_programmatic_ui/README.md for details
    # =========================================================================
