...
def run_performance_validation(config_path: str, output_html: str | None = None, output_json: str | None = None):
    ...
    for target_name, benchmark_func in benchmarks:
        try:
            ...
            logger.exception("benchmark_failed", target=target_name, error=str(e))
            results[target_name] = {
                "success": False,
                "error": str(e),
            }
